...
import { OPTIONAL_FACEBOOK_SCOPES, REQUIRED_FACEBOOK_SCOPES } from "@/lib/auth/facebook-scopes";

const facebookApiVersion = process.env.META_API_VERSION || "v23.0";
const facebookScopes = Array.from(new Set([...REQUIRED_FACEBOOK_SCOPES, ...OPTIONAL_FACEBOOK_SCOPES])).join(",");
export { OPTIONAL_FACEBOOK_SCOPES, REQUIRED_FACEBOOK_SCOPES };
